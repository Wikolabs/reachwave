  ...
  content: {
    fr: {
      ...
      persuasion: {
        ...
        title: "Vos prospects sont sur 4 canaux. Vous, sur un seul.",
        paragraphs: [
          { type: "pathos", text: "Mardi 14h. Votre commercial envoie un sequence email a 200 prospects, copie le meme paragraphe en message LinkedIn — il sait que c'est paresseux mais il n'a pas le temps de personnaliser 200 fois. Resultat dans 5 jours : 6 reponses tiedes, 3 demandes de desinscription, 1 plainte chez votre CMO parce qu'un prospect a juge le message 'spammy et impersonnel'. Pendant ce temps, votre concurrent a touche les memes prospects sur 4 canaux avec un message different a chaque touche. Devinez qui a obtenu le RDV." },
          { type: "logos", text: "Une etude SalesLoft sur 4.2M de sequences B2B montre que l'outreach multicanal coordonne genere 3.1x plus de reponses qu'une sequence email seule. McKinsey chiffre a 73% la part de prospects B2B qui exigent au moins 3 points de contact sur des canaux differents avant un premier RDV. Gartner predit qu'en 2027, 80% du SDR work qui peut etre automatise le sera — et que les equipes qui refusent perdront 35% de leur pipeline." },
          { type: "ethos", text: "Wikolabs construit des agents IA en production depuis 2023 pour des scale-ups B2B, family offices et fintechs reglementees. Nous avons brule nos doigts sur les memes problemes que vous : pipelines qui hallucinent, briefs ignores, dashboards desertes. ReachWave est ce que nous avons construit pour nos propres clients exigeants avant de le proposer au marche." },
          { type: "solution", text: "Concretement : vous branchez Gmail, LinkedIn et Twilio en 1 clic via OAuth. Vous decrivez votre sequence (timing, ton, canaux). L'IA redige chaque message selon le poste, le secteur, les publications LinkedIn et le comportement de chaque prospect — pas de template generique, jamais le meme message deux fois. Resultat : 12k+ sequences executees chaque mois, 3x plus de reponses, premier RDV en 72h. Vous n'intervenez que pour conclure." },
        ],
      },
    ...
    en: {
      langLabel: "EN",
      tagLabel: "Multichannel outreach · Email · LinkedIn · SMS",
      taglines: ["The right message.", "On the right channel.", "At the right time."],
      taglineAccentIdx: 1,
      desc: "ReachWave orchestrates your multichannel sequences with AI personalization: Email, LinkedIn and SMS in parallel. Multiply your reply rate by 3 with no extra effort.",
      navLinks: [
      ...
      metrics: [
        ...
        { value: "72h", label: "first replies" },
        { value: "12k+", label: "sequences / month" },
        { value: "89%", label: "clients renew" },
      ],
      features: [
        { icon: "📧", title: "Multichannel orchestration", desc: "Email, LinkedIn and SMS coordinated in one intelligent sequence. The AI picks the best channel based on each prospect's profile and behavior." },
        { icon: "🤖", title: "Deep AI personalization", desc: "Every message is written by AI based on role, sector, LinkedIn posts and history. No more generic templates that hurt your brand." },
        { icon: "📊", title: "Real-time dashboard", desc: "Opens, clicks, replies and conversions tracked channel by channel. Spot winning sequences and optimize continuously without effort." },
      ],
      steps: [
        { num: "01", title: "Connect your tools", desc: "Gmail, LinkedIn and Twilio (SMS) via 1-click OAuth. No manual API setup. Your existing stack is connected in under 20 minutes." },
        { num: "02", title: "Define your sequence", desc: "Pick the timing, tone and channels. ReachWave automatically personalizes every message via AI based on each prospect's profile." },
        { num: "03", title: "Activate and watch the results", desc: "The real-time dashboard shows opens, clicks and replies channel by channel. You only step in to close warm conversations." },
      ],
      persuasion: {
        sectionTag: "Why now",
        title: "Your prospects live on 4 channels. You're on one.",
        paragraphs: [
          { type: "pathos", text: "Tuesday 2pm. Your rep sends an email sequence to 200 prospects, copies the same paragraph into LinkedIn DMs — they know it's lazy but they don't have time to personalize 200 messages. Five days later: 6 lukewarm replies, 3 unsubscribes, 1 complaint to your CMO because a prospect called it 'spammy and impersonal'. Meanwhile your competitor hit the same prospects on 4 channels with a different message at each touch. Guess who got the meeting." },
          { type: "logos", text: "A SalesLoft study on 4.2M B2B sequences shows coordinated multichannel outreach generates 3.1x more replies than email alone. McKinsey puts at 73% the share of B2B prospects who require at least 3 touchpoints across different channels before a first meeting. Gartner predicts that by 2027, 80% of automatable SDR work will be automated — and teams that refuse will lose 35% of their pipeline." },
          { type: "ethos", text: "Wikolabs has been building production AI agents since 2023 for B2B scale-ups, family offices and regulated fintechs. We burned our fingers on the same problems you face: hallucinating pipelines, ignored briefs, abandoned dashboards. ReachWave is what we built for our own demanding customers before bringing it to market." },
          { type: "solution", text: "Concretely: you connect Gmail, LinkedIn and Twilio in 1 click via OAuth. You describe your sequence (timing, tone, channels). The AI writes each message based on role, sector, LinkedIn posts and behavior — no generic templates, never the same message twice. Result: 12k+ sequences executed each month, 3x more replies, first meeting in 72h. You only step in to close." },
        ],
      },
      ctaTitle: "Your first replies within 72 hours",
      ctaDesc: "1-day setup. Sequences live the next morning. No credit card.",
      ctaPrimary: "Book a call",
      ctaWhatsApp: "WhatsApp",
      ctaDemo: "Request a demo",
      ctaSoonBadge: "Soon",
      footerTagline: "Multichannel outreach automated by AI",
    },
  },
};
