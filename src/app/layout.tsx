...
export const metadata: Metadata = {
  title: "ReachWave — Sequences outreach multicanal automatisees",
  description: "ReachWave orchestre vos campagnes Email, LinkedIn et SMS avec personnalisation IA. Multipliez votre taux de reponse par 3.",
};
